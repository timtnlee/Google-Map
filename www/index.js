...
function _placeList(places){//list multi places simple info
	...
	places.forEach(function(place){
		...
		$('#infoList').append('<p class="placeTag">'
            +'<span class="placePic"><img src="'+src+'"></span>'
...
function _placeDetail(places){//focus one place's info	
    ...
    service.getDetails({ placeId: id },function(result){
        ...
        name=result.name
        $('#infoDetail').append('<p class="placeTag">'
            +'<span class="placePic"><img src="'+photos[0]+'"></span>'
            +'<span class="placeName">'+name+'</span></p>'
